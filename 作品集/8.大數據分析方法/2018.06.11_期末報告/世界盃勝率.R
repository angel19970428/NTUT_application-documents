...
chart1<-
  ...
  theme_light()+
  labs(title="世界盃參賽國家勝率(世界盃)條狀圖",x="國家",y="勝率")+
...
chart2<-
  ...
  labs(title="世界盃參賽國家勝率(世界盃)面量圖")+
  theme(plot.title = element_text(size = 20 , hjust = 0.5))
chart2

# write.csv(WCchart2,file="C:/Users/Peter/Desktop/WC_teams_FIFAwinrate.csv",
